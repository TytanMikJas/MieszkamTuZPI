import {
  ...
  export const DISTRICT_NAME_JAJOSTY = 'JAJOSTY';
  export const DISTRICT_NAME_BIERUN_NOWY = 'BIERUN_NOWY';
  export const DISTRICT_NAME_KOPAN = 'KOPAN';
  export const DISTRICT_NAME_LIGNOZA = 'LIGNOZA';
  export const DISTRICT_NAME_CZARNUCHOWICE = 'CZARNUCHOWICE';
  export const DISTRICT_NAME_BIJASOWICE = 'BIJASOWICE';
  export const DISTRICT_NAME_LYSINA = 'LYSINA';
  export const DISTRICT_NAME_WITTA = 'WITTA';
  export const DISTRICT_NAME_BIERUN_STARY = 'BIERUN_STARY';
  export const DISTRICT_NAME_NORAS = 'NORAS';
  export const DISTRICT_NAME_SCIERNIE = 'SCIERNIE';
  export const DISTRICT_NAME_BARANIEC = 'BARANIEC';
  
  export const DISTRICT_LABEL_JAJOSTY = 'Jajosty';
  export const DISTRICT_LABEL_BIERUN_NOWY = 'Bieruń Nowy';
  export const DISTRICT_LABEL_KOPAN = 'Kopan';
  export const DISTRICT_LABEL_LIGNOZA = 'Lignoza';
  export const DISTRICT_LABEL_CZARNUCHOWICE = 'Czarnuchowice';
  export const DISTRICT_LABEL_BIJASOWICE = 'Bijasowice';
  export const DISTRICT_LABEL_LYSINA = 'Łysina';
  export const DISTRICT_LABEL_WITTA = 'Witta';
  export const DISTRICT_LABEL_BIERUN_STARY = 'Bieruń Stary';
  export const DISTRICT_LABEL_NORAS = 'Noras';
  export const DISTRICT_LABEL_SCIERNIE = 'Ściernie';
  export const DISTRICT_LABEL_BARANIEC = 'Baraniec';
  ...
  export const INVESTMENT_CREATOR_DISTRICT_PLACEHOLDER = 'Wybierz dzielnicę';
  ...
  export const LISTING_CREATOR_DISTRICT_PLACEHOLDER = 'Wybierz dzielnicę';
  ...
  export const ANNOUNCEMENT_CREATOR_DISTRICT_PLACEHOLDER = 'Wybierz dzielnicę';
